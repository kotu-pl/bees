...
class TransferDenseNetLitModel(pl.LightningModule):
    ...
    def adjust_fc_layer(self):
        ...
        self.model.classifier = nn.Linear(num_in_features, self.num_classes)
    ...
    def configure_optimizers(self):
        # tylko trenowalne parametry (czyli classifier po zamrożeniu reszty)
